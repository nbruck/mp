 ...
 */
public class HibernatePersistenceServiceTestParallelWriting extends TestBase
{
    private final int dbRequestSize = 20;
    ...
    private class DBRequest extends Thread
    {
        ...
        public void run() {
            for(int i = 0; i < mileagesToStore.length; i++) {
                ...
                try {
                    persistenceService.saveNewCarData(
                        new CarDataEntity(
                            "t-" + threadId,
                            threadId * mileagesToStore[i] + ctr,
                            new Date(),
                            null,
                            null,
                            2,
